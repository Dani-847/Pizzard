...
public class PinaPinaPinaAttack : CharacterProjectile
{
    [Header("Subproyectiles")]
    public GameObject smallExplodingPrefab;
    ...
    {
        if (smallExplodingPrefab == null) return;
        ...
        foreach (var dir in directions)
        {
            ...
            GameObject proj = Instantiate(smallExplodingPrefab, spawnPosition, rotation);
