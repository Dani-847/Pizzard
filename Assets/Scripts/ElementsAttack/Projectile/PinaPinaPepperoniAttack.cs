...
public class PinaPinaPepperoniAttack : CharacterProjectile
{
    [Header("Subproyectiles")]
    public GameObject smallBurningPrefab;
    ...
    {
        if (smallBurningPrefab == null) return;
        ...
        foreach (var dir in directions)
        {
            ...
            GameObject proj = Instantiate(smallBurningPrefab, spawnPosition, rotation);
