...
public class QuesoPepperoniQuesoArea : MonoBehaviour
{
    [Header("Settings")]
    public float duration = GameBalance.Spells.QuesoPepperoniQueso.AreaDuration;
    public float tickDamage = GameBalance.Spells.QuesoPepperoniQueso.TickDamage;
    public float tickInterval = GameBalance.Spells.QuesoPepperoniQueso.TickInterval;
    public float burnDuration = GameBalance.Spells.QuesoPepperoniQueso.BurnDuration;
    public int burnStacks = GameBalance.Spells.QuesoPepperoniQueso.BurnStacks;
    public float radius = GameBalance.Spells.QuesoPepperoniQueso.Radius;
