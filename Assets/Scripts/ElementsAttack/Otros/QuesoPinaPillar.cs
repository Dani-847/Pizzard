...
public class QuesoPinaPillar : MonoBehaviour
{
    [Header("Settings")]
    public float duration = GameBalance.Spells.QuesoPina.PillarDuration;
    public float tickDamage = GameBalance.Spells.QuesoPina.TickDamage;
    public float tickInterval = GameBalance.Spells.QuesoPina.TickInterval;
    public float radius = GameBalance.Spells.QuesoPina.Radius;
