...
public static class FixButtonTextsEditor
{
    [MenuItem("Tools/FixButtonTexts")]
    public static void Execute()
    {
        ...
        if (uiRoot != null)
        {
            Transform menuUI = uiRoot.transform.Find("MenuUI");
            if (menuUI != null)
            {
                Transform panelMenu = menuUI.transform.Find("PanelMenu(Clone)"); // sometimes instantiated
                if (panelMenu == null) panelMenu = menuUI.transform.Find("PanelMenu");
        ...
        Debug.Log("Button texts explicitly set!");
    }
}
